  ...
  <demo-block title="完全自定义展示逻辑">
    <section>
      ...
      <mask-txt :preset="commonPreset" mask-id="maskId" :mask-txt="dataSourceCipherTxt">
        <template #default="{ showValue, loading, isPlaintextVisible, toggleVisibility }">
...
import { Field as VanField, Button as VanButton, Icon as VanIcon, Loading as VanLoading } from 'vant';
